 ...
 * @date 2024-06-20
 * Ejercicio 9.
Utilizando estructuras en C++ crear un programa que pueda hacer una estructura en C++ que registre
los datos de cinco personas como: Nombre, apellido, edad, sexo y teléfono
